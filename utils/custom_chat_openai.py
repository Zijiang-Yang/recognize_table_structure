...
class Prompt(Base):
    __tablename__ = 'flatten_table_all_model_prompt'
    ...
    model_input_cost_usd = Column(Float)
    model_input_cost_cny = Column(Float)
    model_output_cost_usd = Column(Float)
    model_output_cost_cny = Column(Float)
    total_cost_usd = Column(Float)
    total_cost_cny = Column(Float)
    ...
    def insert_data(self, data):
        ...
        try:
            new_entry = Prompt(
                ...
                model_input_cost_usd = data.get("model_input_cost_usd", ""),
                model_input_cost_cny = data.get("model_input_cost_cny", ""),
                model_output_cost_usd = data.get("model_output_cost_usd", ""),
                model_output_cost_cny = data.get("model_output_cost_cny", ""),
                total_cost_usd = data.get("total_cost_usd", ""),
                total_cost_cny = data.get("total_cost_cny", "")
                )
        ...
        cost_data = {
            "ai_chain_name": 'flatten_table',
            "ai_chain_usage_type": "outer",
            "ai_chain_task_type": "answer_generate",
            "ai_chain_cost": data.get("total_cost_cny", ""),
            "ai_chain_input": input_data.info,
            "ai_chain_prompt": data.get("model_input", ""),
            "ai_chain_output": data.get("model_output", ""),
            "ai_chain_result": '  '
        }
        if False:
            self._insert_cost_data(cost_data)
...
class CustomChatOpenAI(AzureChatOpenAI, Runnable):
    ...
    def special_save_train_data(self, model_input: str, model_output: str, start_time, end_time):
        ...
        model_input_cost_usd = MODEL_COST_PER_1K_TOKENS.get(self._get_offical_model_name(), 0)/1000 * model_input_token
        model_input_cost_cny = model_input_cost_usd * 7
        model_output_token = len(encoding.encode(model_output))
        model_output_cost_usd = MODEL_COST_PER_1K_TOKENS.get(self._get_offical_model_name()+"-completion", 0)/1000 * model_output_token
        model_output_cost_cny = model_output_cost_usd * 7
        total_cost_usd = model_input_cost_usd + model_output_cost_usd
        total_cost_cny = model_input_cost_cny + model_output_cost_cny
        data = {
            ...
            "model_input_cost_cny": model_input_cost_cny,
            "model_output_cost_usd": model_output_cost_usd,
            "model_output_cost_cny": model_output_cost_cny,
...
class CustomQwenChatOpenAI(ChatOpenAI, Runnable):
    ...
    def special_save_train_data(self, model_input: str, model_output: str, start_time, end_time):
        data = {
            ...
            "model_input_cost_usd": float(0),
            "model_input_cost_cny": float(0),
            "model_output_cost_usd": float(0),
            "model_output_cost_cny": float(0),
